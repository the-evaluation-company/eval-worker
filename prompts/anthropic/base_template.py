"""
Base credential analysis prompt template for Anthropic Claude.

This template has a placeholder {DOCUMENT_TYPE_INSTRUCTIONS} that gets filled
with document-type-specific instructions.
"""

CREDENTIAL_ANALYSIS_TEMPLATE = """
